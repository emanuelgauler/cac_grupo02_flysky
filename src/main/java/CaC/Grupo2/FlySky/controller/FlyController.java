...
public class FlyController {
    ...
    public ResponseEntity<?> getHistorial(@RequestParam TipoUsuarioEnum tipoUsuario, @RequestParam Long usuarioID) {
        return new ResponseEntity<>(flyService.getHistorial(tipoUsuario,usuarioID), HttpStatus.OK);
    }
